...
2.  **Write down the absolute path** to your `cloudspan` folder.
    ...
    -   **Mac Users**: select Click on the folder in Finder *View path bar*, then look at the bottom where your file structure is shown, right click foldername and chose Copy 'cloudspan' as pathname
