...
``` {.bash filename="Code"}
chmod 400 login-key-login-key-instanceNNN.pem 
```
 ...
 * Support:        https://ubuntu.com/advantage
  ...
  System information as of Thu 30 Apr 2026 12:54:38 PM UTC

  System load:  0.0                 Processes:                251
  Usage of /:   93.1% of 236.08GB   Users logged in:          0
  Memory usage: 3%                  IPv4 address for docker0: 172.17.0.1
  Swap usage:   0%                  IPv4 address for eth0:    10.0.63.144

  => / is using 93.1% of 236.08GB
...
452 updates can be applied immediately.
267 of these updates are ESM Infra security updates.
...
Run 'do-release-upgrade' to upgrade to it.
   ...
   | |___| | (_) | |_| | (_| | |___| ____)  |  __ / ___ \| |\ | |
    \____|_|\___/ \___/ \__,_|       \_____/|_|  /_/   \_|_| \__|
         ...
         METATRANSCRIPTOMICS       COURSE       ENVIRONMENT
...
Last login: Thu Apr 30 09:55:40 2026 from xxxxxxx
```
