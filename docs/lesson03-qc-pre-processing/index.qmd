...
![](/images/metatranscriptomics_flowchart_short.png){fig-align="center" width="300" fig-alt="Flow diagram that shows the steps: Sequence reads, Quality control, Trimming, Filtering, Community Analysis, Functional Analysis."}
