...
3.  In our sample we identified:\
    *Coprothermobacter proteolyticus, Acetivibrio thermocellus, Tepidanaerobacter sp. GT38, Methanothermobacter thermautotrophicus,* and *Escherichia coli*.

4.  Trick question! Although you can manually verify each taxon, you would need to adjust the `--tax_lev` flag to show the kingdom (`k__`) level to formally confirm whether only bacteria are present.
:::
::::
