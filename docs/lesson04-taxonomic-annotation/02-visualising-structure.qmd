...
Because Krona outputs are portable .html files these can be sent to collaborators or uploaded for others to browse. However this format is not entirely suitable for publication.
