...
::: callout-tip
The explanations below are brief and do not go into technical detail, instead only just touches on which kinds of experiment the analyses are appropriate for.

Each section has links out to other tutorials you may find useful!
