...
-   following a metatranscriptomics analysis workflow including:
    -   quality control on RNA-seq reads

    -  adapter trimming and quality filtering

    -   Removing rRNA sequences from RNA-seq data

    -   preparing reads for downstream analyses

    -   taxonomic profiling of metatranscriptomic data

    -   functional interpretation of expressed genes

    -   exploring results using interactive tools such as Krona
...
This course assumes no prior experience with the tools covered in the workshop, but learners are expected to have a basic understanding of biological concepts, including gene expression, mRNA, and microbiomes. Participants should bring their own laptops and be prepared to engage actively in hands-on metatranscriptomics exercises.
...
| [QC & Sorting](docs/lesson03-qc-pre-processing/index.qmd)                                     | How to quality control and sort transcript reads.                                                                                          |
| [Taxonomic Annotation](docs/lesson04-taxonomic-annotation/index.qmd)                                           | How to use Metaphlan to identify taxonomy of transcript reads                                                                              |
| [Functional Annotation](docs/lesson05-functional-annotation/index.qmd) | How to use Humann to identify functional genes from your sorted transcript reads.                                                     |
